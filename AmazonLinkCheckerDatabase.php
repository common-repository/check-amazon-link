...
if ( ! class_exists( 'AmazonLinkCheckerDatabase' ) ) :
	class AmazonLinkCheckerDatabase {
		...
		public function addIndexes() {
			/* @var WPDB $wpdb */
			global $wpdb;
			@$wpdb->query("CREATE INDEX asin_ix ON " . $this->link_instances_table . " (asin)");
			@$wpdb->query("CREATE INDEX asin_ix ON " . $this->product_table . " (asin)");
			@$wpdb->query("CREATE INDEX asin_ix ON " . $this->product_data_table . " (asin)");
		}
