...
class simple_html_dom
{
    ...
    protected function copy_until_char($char)
    {
        ...
        if (($pos = stripos($this->doc, $char, $this->pos))===false) {
    ...
    protected function copy_until_char_escape($char)
    {
        ...
        while (1)
        {
            if (($pos = stripos($this->doc, $char, $start))===false)
            {
                $ret = substr($this->doc, $this->pos, $this->size-$this->pos);
                $this->char = null;
                $this->pos = $this->size;
    ...
    function restore_noise($text)
    {
        ...
        while (($pos=stripos($text, '___noise___'))!==false)
        {
    ...
    function search_noise($text)
    {
        ...
        {
            if (stripos($noiseElement, $text)!==false)
            {
                return $noiseElement;
            }
        }
